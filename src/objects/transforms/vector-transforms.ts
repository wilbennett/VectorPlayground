import { Tristate, ValueType, Vec } from '../../core';
...
class VectorTransforms {
  @transform(ValueType.vector, "{input}̂", true)
  normalize = (v: TriVec) => v ? v.normalizeN() : Vec.emptyDirection;

  @transform(ValueType.vector, "-{input}")
  negate = (v: TriVec) => v ? v.negateN() : Vec.emptyDirection;
