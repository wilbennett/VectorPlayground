...
export class Dot extends Calculation {
  constructor() {
    super(Dot.name);
    ...
    this._descriptionFormat = "<b>{p1} ● {p2}</b><br/>{p1}.x * {p2}.x + {p1}.y * {p2}.y";
...
worldAssigned.then(world => world.addObjects(new Operation(Dot.name, Dot)));
